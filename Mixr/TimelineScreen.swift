...
struct TimelineScreen: View {
    ...
    /// Alert chrome scale for this screen — see MixrAlertChrome.scale.
    ...
    var body: some View {
        GeometryReader { geo in
            ...
            .onChange(of: layout.contentScale, initial: true) { _, value in
                alertScale = MixrAlertChrome.scale(forContentScale: value)
            }
